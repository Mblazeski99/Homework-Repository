        ...
        static void Main(string[] args)
        {
            ...
            switch (roleChoice)
            {
                case 1:
                    ...
                    {                  
                        Console.Clear();
                        userChoice = uiService.AdminChoice(loggedIn); // added loggedIn inside the adminChoice method since now it requires a paramater
                        if (userChoice == 1)
                        {
                        ...
                        else if (userChoice == 2)
                        {
                            ...
                            Console.ReadLine();
                            break;
                        } else if(userChoice == 3) // this entire else if was added for the Show Users option
                        {
                            for(int i = 0; i < usersDB.Count; i++)
                            {
                                Console.WriteLine($"{usersDB[i].FirstName} {usersDB[i].LastName} - {usersDB[i].Role}");                                
                            }
                            break;
                        }
                        else
                ...
                case 2:
                    ...
                    {
                        Console.Clear();
                        userChoice = uiService.TrainerChoice(loggedIn); // added loggedIn inside the adminChoice method since now it requires a paramater
                        if (userChoice == 1)
                        {
                        ...
                        {
                            uiService.ShowSubjects(subjectsDB); // fixed this line so it prints out the subjects instead of the students
                            break;
                        }
                        else
                        {
                ...
                case 3:
                    Console.Clear();
                    userChoice = uiService.StudentChoice(loggedIn); // added loggedIn inside the adminChoice method since now it requires a paramater
                    while (true)
                    {
                        if (userChoice == 1)
                        {
                        ...
                        else if(userChoice == 3) // this entire else if was added for the AverageGrades option
                        {
                            Console.WriteLine("Your average grade is:");
                            currentStudent.AverageGrades();
                            break;
                        }
                        else
                        {
